  ...
  group('AverageCalculationService', () {
    group('calcDateAverages', () {
      ...
      test('calculates correct averages for single entry', () {
        ...
        expect(result[DateTime.utc(2024, 1, 1)], equals(70.0));
      });
      ...
      test('calculates correct averages for consecutive entries', () {
        ...
        expect(result[DateTime.utc(2024, 1, 2)], equals(70.5));
        
        // Day 3: 70kg + 71kg + 69kg = 70.0kg
        expect(result[DateTime.utc(2024, 1, 3)], equals(70.0));
      });
      ...
      test('handles entries with gaps correctly', () {
        ...
        final entries = [
          WeightEntry(weight: 70.0, date: DateTime.utc(2024, 1, 1)),
          WeightEntry(weight: 72.0, date: DateTime.utc(2024, 1, 5)), // Gap of 3 days
          WeightEntry(weight: 68.0, date: DateTime.utc(2024, 1, 7)),
        ];
        const averagingPeriod = 3;
        ...
        expect(result[DateTime.utc(2024, 1, 2)], equals(70.0));
        expect(result[DateTime.utc(2024, 1, 3)], equals(70.0));
        expect(result[DateTime.utc(2024, 1, 4)], equals(70.0));
        
        // Day 5: Only 72kg
        expect(result[DateTime.utc(2024, 1, 5)], equals(72.0));
        
        // Day 6: Use previous average (72.0)
        expect(result[DateTime.utc(2024, 1, 6)], equals(72.0));
        
        // Day 7: 72kg + 68kg = 70.0kg (from Jan 5 and Jan 7)
        expect(result[DateTime.utc(2024, 1, 7)], equals(70.0));
      });
      ...
      test('handles different averaging periods correctly', () {
        ...
        expect(result2Day[DateTime.utc(2024, 1, 1)], equals(70.0)); // Only 70kg
        expect(result2Day[DateTime.utc(2024, 1, 2)], equals(70.5)); // (70+71)/2
        expect(result2Day[DateTime.utc(2024, 1, 3)], equals(70.0)); // (71+69)/2
        expect(result2Day[DateTime.utc(2024, 1, 4)], equals(70.5)); // (69+72)/2
        ...
        expect(result4Day[DateTime.utc(2024, 1, 1)], equals(70.0)); // Only 70kg
        expect(result4Day[DateTime.utc(2024, 1, 2)], equals(70.5)); // (70+71)/2
        expect(result4Day[DateTime.utc(2024, 1, 3)], equals(70.0)); // (70+71+69)/3
        expect(result4Day[DateTime.utc(2024, 1, 4)], equals(70.5)); // (70+71+69+72)/4
      });
      ...
      test('handles entries with same date correctly', () {
        ...
        expect(result[DateTime.utc(2024, 1, 1)], equals(70.25));
        
        // Day 2: avg(avg(70.0 + 70.5) + 71.0) = 70.625kg
        expect(result[DateTime.utc(2024, 1, 2)], equals(70.625));
      });
      ...
      test('handles edge case with averaging period of 1', () {
        ...
        final entries = [
          WeightEntry(weight: 70.0, date: DateTime.utc(2024, 1, 1)),
          WeightEntry(weight: 71.0, date: DateTime.utc(2024, 1, 3)),
        ];
        ...
        // Day 3: Only 71kg
        expect(result[DateTime.utc(2024, 1, 3)], equals(71.0));
      });
      ...
      test('returns dates in chronological order', () {
        ...
        final entries = [
          ...
          WeightEntry(weight: 71.0, date: DateTime.utc(2024, 1, 1)),
          WeightEntry(weight: 69.0, date: DateTime.utc(2024, 1, 2)),
        ];
        const averagingPeriod = 2;
      ...
      test('handles complex scenario with multiple entries per day', () {
        ...
        final entries = [
          WeightEntry(weight: 70.0, date: DateTime.utc(2024, 1, 1)),
          WeightEntry(weight: 70.5, date: DateTime.utc(2024, 1, 1)), // Same day
          WeightEntry(weight: 71.0, date: DateTime.utc(2024, 1, 2)),
          WeightEntry(weight: 69.0, date: DateTime.utc(2024, 1, 3)),
          WeightEntry(weight: 69.5, date: DateTime.utc(2024, 1, 3)), // Same day
        ];
        const averagingPeriod = 3;
        ...
        expect(result[DateTime.utc(2024, 1, 3)], equals(70.167));
      });
      ...
      test('handles single day with multiple measurements', () {
        ...
        final entries = [
          WeightEntry(weight: 70.0, date: DateTime.utc(2024, 1, 1)),
          WeightEntry(weight: 70.5, date: DateTime.utc(2024, 1, 1)),
          WeightEntry(weight: 71.0, date: DateTime.utc(2024, 1, 1)),
        ];
        const averagingPeriod = 2;
